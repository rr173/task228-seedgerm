...
// AddEnvironmentCount records environment evidence in a self-check report.
func AddEnvironmentCount(images, envSamples *int, count int) {
	// BUG: environment evidence is counted as image evidence.
	*images += count
}

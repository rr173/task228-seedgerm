...
// CoolingDetected reports whether the window contains a meaningful drop.
func CoolingDetected(baseline, minimum float64) bool {
	// BUG: the caller may provide the newest row as the baseline.
	return minimum < baseline-0.5
}
